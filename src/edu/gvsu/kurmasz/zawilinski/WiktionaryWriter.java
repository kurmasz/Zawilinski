...
/****************************************************************
 * Writes a Wiktionary DOM structure back out to XML
 * 
...
public class WiktionaryWriter
{
	 ...
	 * 
	 * @param contextPath
	 *            the location of the objects corresponding to the MediaWiki
	 *            elements.
	 * 
	...
	/**************************************************************************
	 * Constructor using same context path as {@code l}.
	 * 
	 * @param l
	 *            the {@code WiktionaryLoader} whose context path is to be used.
	 **************************************************************************/
	public WiktionaryWriter(MediaWikiLoader l) {
		//this(l.getContextPath());
	}
	 ...
	 * 
	 * @param value
	 *            {@code true} for nice formatting {@code false} otherwise.
	 * @throws XMLConfigurationException
	 *             if the underlying call to {@code setProperty} throws an
	 *             exception.
	 **************************************************************************/
	 ...
	 *             when there is an error processing the given property.
	 **************************************************************************/
	 ...
	 *            root of the data
	 * @param file
	 *            file to write to (or "-" for STDIN)
	 * @throws JAXBException
	 *             if anything strange happens.
	 * @throws FileNotFoundException
	 *             if {@code file} can't be written
	 **************************************************************************/
	public void write(JAXBElement<?> root, String file)
			throws FileNotFoundException, JAXBException
	{
		OutputStream output;
		if (file.equals(Util.STDOUT)) {
			output = System.out;
		} else {

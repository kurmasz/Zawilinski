...
//      } catch (XMLLoader.XMLConfigurationException xmlce) {
...
//
//      verify(log).println(XMLLoader.PARSE_BEGIN_END, "Begin unmarshal.");
//   }
...
//      MediaWikiLoader.load(source, log, unmarshaler);
//
//      verify(log).println(XMLLoader.PARSE_BEGIN_END, "Complete unmarshal.");
//   }
//
//   @Test

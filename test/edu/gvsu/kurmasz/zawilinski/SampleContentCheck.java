...
public class SampleContentCheck {
   ...
   public static void verifyMWSampleContentOther(MediaWikiType doc) {
      ...
      assertEquals("MediaWiki 1.16alpha-wmf", siteInfo.getGenerator());
      ...
      assertEquals("MadeUpValue", namespaces.get(1).getValue());
      assertEquals(new BigInteger("37"), namespaces.get(1).getKey());
      ...
      List<Object> p1revs = page1.getRevisionOrUploadOrLogitem();
      assertEquals(2, p1revs.size());

      // page 1, revision 1
      RevisionType p1r1 = (RevisionType) p1revs.get(0);
      assertEquals(11, p1r1.getId().intValue());
      ...
      assertEquals(22, timestamp.getHour());
      ...
      assertEquals(12, p1r2.getId().intValue());
      timestamp = p1r2.getTimestamp();
      assertEquals(2010, timestamp.getYear());
      assertEquals(6, timestamp.getMonth());
      assertEquals(14, timestamp.getDay());
      ...
      List<Object> p2revs = page2.getRevisionOrUploadOrLogitem();

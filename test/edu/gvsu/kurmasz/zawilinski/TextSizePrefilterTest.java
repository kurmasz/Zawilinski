...
public class TextSizePrefilterTest extends TextPrefilterTest {
   ...
   public void logEntryGeneratedWhenOverflow() throws Throwable {
      ...
      verify(log).println(TextSizePrefilter.TRUNCATIONS, "15 9 Mark Twain");
   }
   ...
   public void filterWritesToLog() throws Throwable {
      ...
      verify(mlog).println(TextSizePrefilter.TRUNCATIONS, "27 19 Sample page 1");
      verify(mlog).println(TextSizePrefilter.TRUNCATIONS, "41 19 Sample page 2");
      verify(mlog).println(TextSizePrefilter.TRUNCATIONS, "27 19 Sample page 2");
